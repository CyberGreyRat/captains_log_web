...
<body class="bg-slate-50 text-slate-800 flex flex-col h-screen overflow-hidden">
        ...
        <div class="mx-auto flex h-24 max-w-screen-2xl items-center justify-between px-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <button onclick="document.getElementById('newProjectModal').classList.remove('hidden')"
                    class="rounded border border-white px-3 py-1 text-sm hover:bg-white hover:text-[#0d3158] transition">Neues Projekt</button>
    ...
    <nav class="border-b bg-white shadow-sm shrink-0">
        <div class="mx-auto flex max-w-screen-2xl px-6">
            ...
            <button class="tab border-b-2 border-transparent px-4 py-3 font-medium text-slate-600 hover:text-blue-900 transition-colors" data-panel="stakeholders">Stakeholder</button>
            <button class="tab border-b-2 border-transparent px-4 py-3 font-medium text-slate-600 hover:text-blue-900 transition-colors" data-panel="usecases">Use Cases</button>
            <button class="tab border-b-2 border-transparent px-4 py-3 font-medium text-slate-600 hover:text-blue-900 transition-colors" data-panel="userstories">User Stories</button>
    ...
    <div id="newProjectModal" class="fixed inset-0 hidden items-center justify-center bg-slate-900/60 p-4 z-50">
        <form method="POST" action="../api/web_create_project.php" class="w-full max-w-md space-y-4 rounded-lg bg-white p-6 shadow-2xl">
            ...
            <div class="flex justify-end gap-3 mt-6 border-t pt-4">
                <button type="button" onclick="document.getElementById('newProjectModal').classList.add('hidden')" class="rounded border px-4 py-2 hover:bg-slate-50 font-medium transition">Abbrechen</button>
