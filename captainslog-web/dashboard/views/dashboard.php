...
<div class="flex flex-col h-full overflow-y-auto p-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white p-5 rounded-xl border shadow-sm border-l-4 border-l-blue-900">
        ...
        <div class="bg-white p-5 rounded-xl border shadow-sm border-l-4 border-l-amber-500">
        ...
        <div class="bg-white p-5 rounded-xl border shadow-sm border-l-4 border-l-emerald-500">
    ...
    <div class="bg-white p-6 rounded-xl border shadow-sm">
        <h3 class="font-bold text-slate-800 text-lg mb-4">Projekt-Statusübersicht</h3>
        <p class="text-slate-500 text-sm">Wähle oben im Projekt-Dropdown ein Projekt aus, um die Live-Kennzahlen zu laden.</p>
    </div>
</div>