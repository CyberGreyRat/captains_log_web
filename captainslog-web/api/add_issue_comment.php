...
require_edit_permission();$d=json_decode(file_get_contents('php://input'),true)?:[];$id=(int)($d['issue_id']??0);$text=trim($d['comment_text']??'');if(!$id||!$text)throw new Exception('Kommentar fehlt.');
